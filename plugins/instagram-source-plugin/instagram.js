...
const scrapingInstagramPosts = async ({ username }) => {
  return axios
    .get(
...
exports.scrapingInstagramHashtags = async ({ hashtag }) => {
  return axios
...
exports.scrapingInstagramUser = async ({ username }) => {
  return axios
...
exports.apiInstagramPosts = async ({
  access_token,
  instagram_id,
  username,
  paginate = `100`,
